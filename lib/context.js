...
(function () {
    ...
    var path = require('path'),
        ...
        DEFAULT_IGNORE_LIST = ['.DS_Store', 'node_modules/*', 'node_modules\\*', '.chcp*', '.gitignore', '.git', 'package.json'];
    ...
    var Context = function Context(argv) {
        ...
        DEFAULT_IGNORE_LIST.push(this.argv.m || 'hybrid.manifest.json');
        DEFAULT_IGNORE_LIST.push(this.argv.r || 'release.json');
    };
